...
Lectura Multiformato: Carga archivos independientes de clientes y compras en formato CSV o JSON.
Limpieza de Datos: Tolera inconsistencias, campos nulos y elimina registros duplicados.
Relación de Entidades: Une compras con clientes a través del correo electrónico. Los pedidos cuyos clientes no existen se catalogan y aíslan de forma segura como pedidos huérfanos.
...
Reportes Finales: Exporta el análisis a elección del usuario en formato JSON o XML.
